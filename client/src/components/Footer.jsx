      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <span className="font-display text-2xl font-bold text-white">{settings.storeName}</span>
            ...
            <div className="flex items-center gap-3 mt-4">
              {settings.whatsapp && (
                <a
                  ...
                  className="w-8 h-8 bg-green-600/20 text-green-500 rounded-full flex items-center justify-center hover:bg-green-600/30 transition-colors"
                  title="WhatsApp"
                >
              ...
              {settings.facebookUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-blue-600/20 text-blue-500 rounded-full flex items-center justify-center hover:bg-blue-600/30 transition-colors"
                  title="Facebook"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              {settings.instagramUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-pink-600/20 text-pink-500 rounded-full flex items-center justify-center hover:bg-pink-600/30 transition-colors"
                  title="Instagram"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-gray-500 text-sm">
              ...
              <a href={`tel:${settings.phone}`} className="flex items-center gap-2 hover:text-brand-400 transition-colors">
                <span>📞</span> {settings.phone}
              </a>
              <a href={`mailto:${settings.email}`} className="flex items-center gap-2 hover:text-brand-400 transition-colors">
          ...
          {settings.whatsapp && (
            <div>
              <h4 className="text-white font-medium uppercase tracking-widest text-xs mb-4">Commande Rapide</h4>
              <a
                href={`https://wa.me/${settings.whatsapp.replace(/\D/g, '')}?text=Bonjour, je souhaite passer une commande sur ${encodeURIComponent(settings.storeName)}`}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-dark-300 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-xs">© {new Date().getFullYear()} {settings.storeName}. Tous droits réservés.</p>
